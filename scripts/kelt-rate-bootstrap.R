...
dat = data.frame(
  ...
  total_tagged   = c(2782,       2087,    1395,    1068,    1442,    2262),
  total_detected = c( 228,         97,      78,      66,     275,     489),
  detection_mean = c(0.09193, 0.05564, 0.04755, 0.06659, 0.24323, 0.41235),
  detection_lwr  = c(0.06949, 0.03953, 0.03263, 0.04787, 0.20213, 0.34637),
  detection_upr  = c(0.12066, 0.07779, 0.06879, 0.09191, 0.28964, 0.48164)
)
